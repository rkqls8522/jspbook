...
%>
<FORM name="msgwrite"  method=POST action="pds_upddb.jsp?id=<%=id%>&page=<%=p%>">
 ...
 <td colspan="2" align="right"> 
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr> 
      ...
      <td width="12%"><A href="pds_list.jsp?go=<%=request.getParameter("page") %>"> <img src="image/list.gif" width="48" height="19" border=0></a></td>
     </tr>
  </table>
 </td>
</tr>
