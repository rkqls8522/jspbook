...
<HTML>
<HEAD><TITLE>PDS(검색모드)</TITLE>
</HEAD>
<BODY>
<P>
<P align=center><img src=image/pds.jpg></P> 
<FORM method=post name=search action="pds_search.jsp">
...
<tr align="center" bgcolor="#87E8FF"> 
   <td width="38" bgcolor="#8EA2FF"><font size="2">번호</font></td>
   <td width="259" bgcolor="#8EA2FF"><font size="2">제목</font></td>
   <td width="65" bgcolor="#8EA2FF"><font size="2">등록자</font></td>
   <td width="51" bgcolor="#8EA2FF"><font size="2">날짜</font></td>
   <td width="111" bgcolor="#8EA2FF"><font size="2">첨부파일</font></td>
   <td width="26" bgcolor="#8EA2FF"><font size="2">조회</font></td>
</tr>
<tr align="center"> 
...
try {
 ...
 String sql = "select * from pds " + cond;
 ...
 if (!(rs.next()))  {
    ...
    out.println("<TD>");
         ...
         String clink = "<A href=pds_read.jsp?id=" + keyid.elementAt(j) ;
...
if (wheregroup > 1) {
      out.print("[<A href=pds_search.jsp?gogroup=1"); 
      out.print("&stype="+ what+"&sval=" + val +">처음</A>]");

      out.print("[<A href=pds_search.jsp?gogroup="+priorgroup);
...
if (name.size() !=0) {
  for(int jj=startpage; jj<=endpage; jj++) {
    if (jj==where) 
      ...
      out.print("[<A href=pds_search.jsp?go="+jj);
      out.print("&stype="+ what+"&sval=" + val +">" + jj + "</A>]") ;
     }
  }
}
if (wheregroup < totalgroup) {
      out.print("[<A href=pds_search.jsp?gogroup="+ nextgroup);
      out.print("&stype="+ what+"&sval=" + val +">다음</A>]");
   
      out.print("[<A href=pds_search.jsp?gogroup="+totalgroup); 
...
%>
<p align=center>[<A href="pds_list.jsp">PDS(초기화면)</A>]
</BODY>
</HTML>
