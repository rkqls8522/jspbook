...
<BODY>
 <br><br><br><br><br><br>
<CENTER> 
<FORM name="msgdel" method=post action=pds_deldb.jsp>
...
<tr>                                                              
  <td colspan="2" align="right">                                     
    <table width="100%" border="0" cellpadding="4" cellspacing="4">        
      <tr>                                                          
        <td width="84%">&nbsp;</td>                                             
<td width="8%"><a href="#" onClick="check();"><img src="image/del.gif" width="48" height="19" border="0"></a></td>                                      
 <td width="8%"><a href="pds_list.jsp?go=<%=request.getParameter("page")%> "><img src="image/list.gif" width="48" height="19" border="0"></a></td>
      </tr>                                                      
    </table>                                                      
  </td>                                                          
</tr>                                                            
