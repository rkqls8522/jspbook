...
if (wheregroup > 1) {
        out.println("[<A href=pds_list.jsp?gogroup=1>처음</A>]"); 
        out.println("[<A href=pds_list.jsp?gogroup="+priorgroup +">이전</A>]");
} else {
        out.println("[처음]") ;
        out.println("[이전]") ;
}
...
if (wheregroup < totalgroup) {
   out.println("[<A href=pds_list.jsp?gogroup="+ nextgroup+ ">다음</A>]");
   out.println("[<A href=pds_list.jsp?gogroup="+ totalgroup + ">마지막</A>]");
} else {
         out.println("[다음]");
         out.println("[마지막]");
}
