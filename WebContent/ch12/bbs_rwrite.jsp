...
%>
<FORM name='msgrewrite'  method=POST action="bbs_rsave.jsp?id=
<%=id%>&page=<%=request.getParameter("page")%>">
  <table width="600" cellspacing="0" cellpadding="2">
  <tr> 
    <td colspan="2" bgcolor="#1F4F8F" height="1"></td>
  </tr>
  <tr> 
   <td colspan="2" bgcolor="#8EA2FF" height="20" class="notice">&nbsp;&nbsp;
<font size="2">글 답변하기</font></td>
 ...
 <tr> 
   ...
   <td width="494" style="padding:0 0 0 10" height="25"> 
   <input type=text name=subject size="60" class="input_style2" value="Re :
...
<td width="12%"><a href="bbs_list.jsp?go=<%=request.getParameter("page") %>"><img src="image/list.gif" width="48" height="19" border=0></a></td>
       </tr>
     </table>
   </td>
 </tr>
