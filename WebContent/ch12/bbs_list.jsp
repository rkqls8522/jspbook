...
<BODY>
<P>
<P align=center><img src=image/bbs.jpg></P> 
<P>
<CENTER>
...
<tr align="center" bgcolor="#87E8FF"> 
 	<td width="42" bgcolor="#8EA2FF"><font size="2">번호</font></td>
 	<td width="340" bgcolor="#8EA2FF"><font size="2">제목</font></td>
 	<td width="84" bgcolor="#8EA2FF"><font size="2">등록자</font></td>
 	<td width="78" bgcolor="#8EA2FF"><font size="2">날짜</font></td>
 	<td width="49" bgcolor="#8EA2FF"><font size="2">조회</font></td>
</tr>
...
try {
  ...
  String sql = "select * from bbs order by" ;
  ...
  if (!(rs.next()))  {
     out.println("게시판에 올린 글이 없습니다");
       ...
       if (stepi > 0 ) {
               ...
               out.print("<A href=bbs_read.jsp?id=");
...
if (wheregroup > 1) {
     out.println("[<A href=bbs_list.jsp?gogroup=1>처음</A>]"); 
     out.println("[<A href=bbs_list.jsp?gogroup="+priorgroup +">이전</A>]");
} else {
        out.println("[처음]") ;
        out.println("[이전]") ;
}
if (name.size() !=0) { 
  for(int jj=startpage; jj<=endpage; jj++) {
    if (jj==where) 
      ...
      out.println("[<A href=bbs_list.jsp?go="+jj+">" + jj + "</A>]") ;
 } 
}
if (wheregroup < totalgroup) {
   out.println("[<A href=bbs_list.jsp?gogroup="+ nextgroup+ ">다음</A>]");
   out.println("[<A href=bbs_list.jsp?gogroup="+ totalgroup + ">마지막</A>]");
} else {
         out.println("[다음]");
         out.println("[마지막]");
}
...
%>
<FORM method="post" name="msgsearch" action="bbs_search.jsp">
...
<TR>
    ...
    <TD align=right valign=bottom width="117"><A href="bbs_write.jsp"><img src="image/write.gif" width="54" height="19" border="0"></A> 
    </TD>
  </TR>
</TABLE>
</FORM>
